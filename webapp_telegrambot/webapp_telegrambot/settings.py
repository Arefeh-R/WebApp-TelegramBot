"""
Django settings for webapp_telegrambot project.
...
ROOT_URLCONF = 'webapp_telegrambot.urls'
...
WSGI_APPLICATION = 'webapp_telegrambot.wsgi.application'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=1), # Set a reasonable time
